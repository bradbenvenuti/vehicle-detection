...
def color_hist(img, nbins=32, bins_range=(0, 1)):    #bins_range=(0, 256)
...
def get_features(feature_image, spatial_size=(32, 32), hist_bins=32, orient=9,
...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32), hist_bins=32, orient=9,
	...
	for image in imgs:
		...
		file_features = get_features(feature_image, spatial_size, hist_bins, orient,
